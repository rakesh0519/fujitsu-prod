...
#---------------------------
locals {
  frontend_port_name             = "appgw-${var.app_gateway_name}-feport"
  frontend_ip_configuration_name = "appgw-${var.app_gateway_name}-feip"
...
resource "azurerm_application_gateway" "main" {
  ...
  gateway_ip_configuration {
    ...
    subnet_id = data.azurerm_subnet.gw_snet.id
  }
  ...
  frontend_ip_configuration {
    ...
    subnet_id                     = var.private_ip_address != null ? data.azurerm_subnet.gw_snet.id : null
  }
